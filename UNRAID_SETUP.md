...
- ✅ **Secure Password Generation**: Auto-generates 32+ character passwords for database and JWT
- ✅ **Database Initialization**: Automatically runs migrations and seeds demo data
- ✅ **Health Monitoring**: All containers have health checks and auto-restart
- ✅ **Data Persistence**: All data stored on Unraid array (`/mnt/user/appdata/phm/`)
- ✅ **Network Isolation**: Containers communicate via isolated bridge network
- ✅ **One-Step Updates**: Pull and re-run setup script to update
...
└── init-flag/         # Flag to prevent re-initialization
```
